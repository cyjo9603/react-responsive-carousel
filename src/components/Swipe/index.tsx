...
export function setHasSupportToCaptureOption(hasSupport: boolean) {
...
function getSafeEventHandlerOpts(options: SwipeProps['eventOptions'] = { capture: true }) {
 ...
 */
function getPosition(event: TouchEvent) {
    if ('touches' in event) {
...
class ReactSwipe extends React.Component<SwipeProps> {
    ...
    static propTypes = {
        ...
        eventOptions: PropTypes.oneOfType([PropTypes.object, PropTypes.bool]),
    };
    ...
    componentDidMount() {
        if (this.swiper) {
            this.swiper.addEventListener(
                ...
                getSafeEventHandlerOpts(this.props.eventOptions)
            );
        }
    }
